...
class Cornac_Auditeur_Analyzer_Drupal_Hook5 extends Cornac_Auditeur_Analyzer_Drupal_Hook7 {
	...
	function __construct($mid) {
        ...
        $this->hook_regexp = '_('.join('|',Cornac_Auditeur_Analyzer::getDrupal5Hooks()).')$';
	}
}
