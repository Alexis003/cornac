...
class Cornac_Auditeur_Analyzer_Zf_FormElement extends Cornac_Auditeur_Analyzer
 {
	protected	$title = 'Zend_Form_Element_* used in the application';
	protected	$description = 'List all Zend_Form_Element_* used in the application, including inherited ones.';
...
JOIN <tokens> T1
    ON T1.code = TD.b AND
       T1.type = '_classname_'
WHERE TD.a LIKE "Zend_Form_Element%" AND
