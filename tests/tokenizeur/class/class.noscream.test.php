...
class Noscream_Test extends Cornac_Tests_Tokenizeur
{
    /* 21 methodes */
    ...
    public function testNoscream4()  { $this->generic_test('noscream.4'); }
    public function testNoscream5()  { $this->generic_test('noscream.5'); }
    public function testNoscream6()  { $this->generic_test('noscream.6'); }
    public function testNoscream7()  { $this->generic_test('noscream.7'); }
    public function testNoscream8()  { $this->generic_test('noscream.8'); }
    public function testNoscream9()  { $this->generic_test('noscream.9'); }
    public function testNoscream10()  { $this->generic_test('noscream.10'); }
    public function testNoscream11()  { $this->generic_test('noscream.11'); }
    public function testNoscream12()  { $this->generic_test('noscream.12'); }
    ...
    public function testNoscream19()  { $this->generic_test('noscream.19'); }
