...
//'php_modules' @_, 
'Php_Modules',
//'proprietes_publiques' @_, 
'Classes_PropertiesPublic',
//'returns' @_, 
'Php_Returns',
//'secu_protection_functions' @_, 
'Functions_Security',
//'session_functions' @_, 
'Ext_Session',
'sql_queries',
...
//'undefined_properties' @_, 
'Classes_PropertiesUndefined',
'indenting',
'block_of_call',
//'variables_relations' @_, 
'variables_Relations',
//'arglist_def' @_, 
...
//'variables_one_letter' @_, 
'Variables_OneLetter',
//'variables_lots_of_letter' @_, 
'Variables_LongNames',
//'php_classes' @_, 
'Classes_Php',
//'upload_functions' @_, 
...
'functions_lines',
//'callback_functions' @_, 
'Functions_CallingBack',
'functions_with_callback',
'fluid_interface',
//'function_args_reference' @_, 
